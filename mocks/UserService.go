...
func (_m *UserService) Create(ctx context.Context, user *model.User) (*model.User, error) {
...
func (_c *UserService_Create_Call) Run(run func(ctx context.Context, user *model.User)) *UserService_Create_Call {
...
func (_c *UserService_Create_Call) RunAndReturn(run func(context.Context, *model.User) (*model.User, error)) *UserService_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *UserService_Get_Call) RunAndReturn(run func(context.Context, int64) (*model.User, error)) *UserService_Get_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *UserService_GetByUsername_Call) Return(_a0 *model.User, _a1 error) *UserService_GetByUsername_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *UserService_GetByUsername_Call) RunAndReturn(run func(context.Context, string) (*model.User, error)) *UserService_GetByUsername_Call {
	_c.Call.Return(run)
	return _c
}

// Search provides a mock function with given fields: ctx, query, page, limit
func (_m *UserService) Search(ctx context.Context, query string, page int, limit int) ([]*model.User, int, error) {
...
func (_c *UserService_Search_Call) Return(_a0 []*model.User, _a1 int, _a2 error) *UserService_Search_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *UserService_Search_Call) RunAndReturn(run func(context.Context, string, int, int) ([]*model.User, int, error)) *UserService_Search_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function with given fields: ctx, user
func (_m *UserService) Update(ctx context.Context, user *model.User) (*model.User, error) {
	ret := _m.Called(ctx, user)
...
func (_c *UserService_Update_Call) Run(run func(ctx context.Context, user *model.User)) *UserService_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*model.User))
	})
	return _c
...
func (_c *UserService_Update_Call) RunAndReturn(run func(context.Context, *model.User) (*model.User, error)) *UserService_Update_Call {
	_c.Call.Return(run)
	return _c
}
