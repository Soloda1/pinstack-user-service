...
func (_c *UserRepository_Create_Call) Return(_a0 *models.User, _a1 error) *UserRepository_Create_Call {
...
func (_c *UserRepository_GetByUsername_Call) Return(_a0 *models.User, _a1 error) *UserRepository_GetByUsername_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *UserRepository_GetByUsername_Call) RunAndReturn(run func(context.Context, string) (*models.User, error)) *UserRepository_GetByUsername_Call {
	_c.Call.Return(run)
	return _c
}

// Search provides a mock function with given fields: ctx, searchQuery, offset, pageSize
func (_m *UserRepository) Search(ctx context.Context, searchQuery string, offset int, pageSize int) ([]*models.User, int, error) {
...
func (_c *UserRepository_Search_Call) Return(_a0 []*models.User, _a1 int, _a2 error) *UserRepository_Search_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *UserRepository_Search_Call) RunAndReturn(run func(context.Context, string, int, int) ([]*models.User, int, error)) *UserRepository_Search_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *UserRepository_Update_Call) Return(_a0 *models.User, _a1 error) *UserRepository_Update_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *UserRepository_Update_Call) RunAndReturn(run func(context.Context, *models.User) (*models.User, error)) *UserRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
