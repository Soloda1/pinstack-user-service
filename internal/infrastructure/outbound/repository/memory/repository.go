...
func NewUserRepository(log ports.Logger) *Repository {
	return &Repository{
...
func (r *Repository) Search(ctx context.Context, searchQuery string, offset, pageSize int) ([]*models.User, int, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
